...
const PHONE_NUMBER = "0483 964 440";
const GHL_WEBHOOK_URL = "https://services.leadconnectorhq.com/hooks/Mf8u8bZ4PRZbFQBuWPoH/webhook-trigger/ad79f626-6384-4611-824e-9bed3b4ee9ba";

import { useState } from 'react';

function LeadForm({ title, spacing = "space-y-4", padding = "p-6", inputPadding = "p-3" }: { title?: string, spacing?: string, padding?: string, inputPadding?: string }) {
    ...
    <div className="min-h-screen text-[#1a1a1a] bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="font-bold text-navy text-xl md:text-2xl">
            Bondi Emergency Plumbing
          </div>
          <nav className="hidden lg:flex items-center gap-8 text-sm font-semibold text-navy">
            <a href="#home" className="hover:text-navy underline-offset-4 hover:underline">Home</a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li>Burst Pipe Repairs Bondi</li>
